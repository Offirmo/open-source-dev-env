...
#~/work/src/off/open-source-dev-env/bin/gitc.sh  git@github.com:Offirmo/bangja.git
#~/work/src/off/open-source-dev-env/bin/gitc.sh  git@github.com:Offirmo/cross-js-env-tests.git
#~/work/src/off/open-source-dev-env/bin/gitc.sh  git@github.com:Offirmo/Etendard.git
#~/work/src/off/open-source-dev-env/bin/gitc.sh  git@github.com:Offirmo/internationalize.git
#~/work/src/off/open-source-dev-env/bin/gitc.sh  git@github.com:Offirmo/minisite-w.git
...
#~/work/src/off/open-source-dev-env/bin/gitc.sh  git@github.com:Offirmo/random-js.git
#~/work/src/off/open-source-dev-env/bin/gitc.sh  git@github.com:Offirmo/simplyconfig.git
#~/work/src/off/open-source-dev-env/bin/gitc.sh  git@github.com:Offirmo/tbrpg-model.git
#~/work/src/off/open-source-dev-env/bin/gitc.sh  git@github.com:Offirmo/tbrpg-static-data.git
#~/work/src/off/open-source-dev-env/bin/gitc.sh  git@github.com:Offirmo/web-module-toolbox.git
