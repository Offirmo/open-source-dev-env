...
alias mono3121='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd 3-advanced--multi/; cd view-chat;         tabset --color "#a4d4dd" --badge mono3131'
alias mono3122='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd 3-advanced--multi/; cd view-chat-ui-tty;  tabset --color "#a4d4dd" --badge mono3132'
...
alias mono3240='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd 3-advanced--browser/; cd features-detection-browser; tabset --color "#a4d4dd" --badge mono3202'
alias mono3241='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd 3-advanced--browser/; cd iframe--chat; tabset --color "#a4d4dd" --badge mono3203'
alias mono3242='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd 3-advanced--browser/; cd iframe--loading; tabset --color "#a4d4dd" --badge mono3204'
alias mono3243='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd 3-advanced--browser/; cd react-error-boundary; tabset --color "#a4d4dd" --badge mono3205'
...
alias mono3250='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd 3-advanced--browser/; cd xoff; tabset --color "#a4d4dd" --badge mono3210'
...
alias inc20='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd 5-incubator/active/; cd client--browser;                  tabset --color "#a4d4dd" --badge inc20'
...
alias tbrA01='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd A-apps--core/the-boring-rpg/; cd definitions;        tabset --color "#a4d4dd" --badge tbrA01'

alias tbrA11='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd A-apps--core/the-boring-rpg/; cd logic--armors;      tabset --color "#a4d4dd" --badge tbrA11'
...
alias tbrA23='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd A-apps--core/the-boring-rpg/; cd state--inventory;   tabset --color "#a4d4dd" --badge tbrA23'
alias tbrA24='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd A-apps--core/the-boring-rpg/; cd state--progress;    tabset --color "#a4d4dd" --badge tbrA24'
alias tbrA25='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd A-apps--core/the-boring-rpg/; cd state--wallet;      tabset --color "#a4d4dd" --badge tbrA25'
alias tbrA26='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd A-apps--core/the-boring-rpg/; cd logic--power;       tabset --color "#a4d4dd" --badge tbrA26'

alias tbrA30='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd A-apps--core/the-boring-rpg/; cd state;              tabset --color "#a4d4dd" --badge tbrA30'
alias tbrA31='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd A-apps--core/the-boring-rpg/; cd interfaces;         tabset --color "#a4d4dd" --badge tbrA31'

alias tbrA40='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd A-apps--core/the-boring-rpg/; cd ui--rich-text;      tabset --color "#a4d4dd" --badge tbrA40'
