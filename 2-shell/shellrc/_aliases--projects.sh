...
alias mono3242='cd ~/work/src/off/offirmo-monorepo/stack--current/; nvm use; git--offirmo.sh; cd 3-advanced--browser/; cd iframe--loading; tabset --color "#a4d4dd" --badge mono3242'
