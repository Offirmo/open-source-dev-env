...
alias omr7='cd ~/work/src/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/state-inventory'
alias omr8='cd ~/work/src/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/state-character'
alias omr9='cd ~/work/src/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/view-text'
alias omr10='cd ~/work/src/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/the-boring-rpg'
alias omr='cd ~/work/src/oh-my-rpg; git_offirmo.sh; nvm use'
alias omrA='cd ~/work/src/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/the-boring-rpg-client-cli'
