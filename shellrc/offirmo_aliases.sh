...
alias mono05='cd ~/work/src/off/offirmo-monorepo/1-stdlib; git_offirmo.sh; cd prettify-json; ./.tabset mono05'
...
alias mono110='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd practical-logger-types; ./.tabset mono110'
alias mono111='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd practical-logger-core; ./.tabset mono111'
alias mono112='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd practical-logger-browser; ./.tabset mono112'
alias mono113='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd practical-logger-node; ./.tabset mono113'
alias mono114='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd practical-logger-minimal-noop; ./.tabset mono114'
alias mono120='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd print-error-to-ansi; ./.tabset mono120'
alias mono121='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd ts-types; ./.tabset mono121'


alias orn='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd random; ./.tabset orn'
alias mono21='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd favicon-notifications; ./.tabset mono21'
alias mono24='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd normalize-string; ./.tabset mono24'
alias mono25='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd react-error-boundary; ./.tabset mono25'
alias mono27='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd state; ./.tabset mono27'
alias mono28='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd unicode-data; ./.tabset mono28'
alias mono29='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd unicode-magic; ./.tabset mono29'
alias mono211='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd rich-text-format; ./.tabset mono211'
alias mono212='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd rich-text-format-to-ansi; ./.tabset mono212'
alias mono213='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd rich-text-format-to-react; ./.tabset mono213'
alias mono221='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd universal-debug-api-interface; ./.tabset mono221'
alias mono222='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd universal-debug-api-placeholder; ./.tabset mono222'
alias mono223='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd universal-debug-api-browser; ./.tabset mono223'
alias mono224='cd ~/work/src/off/offirmo-monorepo/3-advanced; git_offirmo.sh; cd universal-debug-api-node; ./.tabset mono224'
...
alias monofi='cd ~/work/src/off/offirmo-monorepo/A-apps/shared; git_offirmo.sh; cd functions-interface && ./.tabset monofi'
alias monof='cd ~/work/src/off/offirmo-monorepo/A-apps/shared; git_offirmo.sh; cd functions && ./.tabset monof'
