...
alias omr11='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd logic-armors; ./.tabset omr11'
alias omr12='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd logic-weapons; ./.tabset omr12'
alias omr13='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd logic-monsters; ./.tabset omr13'
alias omr14='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd logic-adventures; ./.tabset omr14'
alias omr15='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd logic-shop; ./.tabset omr15'
alias omr21='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd rsrc-backgrounds; ./.tabset omr21'
alias omr22='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd rsrc-audio; ./.tabset omr22'
alias omr33='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state-character; ./.tabset omr33'
alias omr34='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state-codes; ./.tabset omr34'
alias omr35='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state-energy; ./.tabset omr35'
alias omr36='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state-engagement; ./.tabset omr36'
alias omr37='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state-inventory; ./.tabset omr37'
alias omr38='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state-meta; ./.tabset omr38'
alias omr39='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state-prng; ./.tabset omr39'
alias omr40='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state-progress; ./.tabset omr40'
alias omr41='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state-wallet; ./.tabset omr41'
alias omr50='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd view-rich-text; ./.tabset omr50'
alias omr51='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd view-browser; ./.tabset omr51'
alias omr52='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd view-browser-react; ./.tabset omr52'
alias omr53='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd audio-browser; ./.tabset omr53'
...
alias tbr01='cd ~/work/src/off/offirmo-monorepo/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd state && ./.tabset tbr01'
alias tbr02='cd ~/work/src/off/offirmo-monorepo/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd interfaces && ./.tabset tbr02'
alias tbr03='cd ~/work/src/off/offirmo-monorepo/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd flux && ./.tabset tbr03'
alias tbr20='cd ~/work/src/off/offirmo-monorepo/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd client-browser && ./.tabset tbr20'
alias tbr30='cd ~/work/src/off/offirmo-monorepo/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd client-cordova && ./.tabset tbr30'
alias tbr40='cd ~/work/src/off/offirmo-monorepo/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd client-node && ./.tabset tbr40'
