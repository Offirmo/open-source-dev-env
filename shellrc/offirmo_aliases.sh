...
alias omr10='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/view-text'
alias omr11='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/state-the-boring-rpg'
