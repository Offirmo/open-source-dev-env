...
alias ogi='cd ~/work/src/off/offirmo.github.io; git_offirmo.sh; nvm use'
alias oin='cd ~/work/src/off/internationalize; git_offirmo.sh; nvm use'
alias omr0='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use'
alias omr1='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/definitions'
alias omr2='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/data'
alias omr3='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/logic-weapons'
alias omr4='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/logic-armors'
alias omr5='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/logic-adventures'
alias omr6='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/state-prng'
alias omr7='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/state-wallet'
alias omr8='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/state-inventory'
alias omr9='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/state-character'
alias omr10='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/state-meta'
alias omr11='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/view-text'
alias omr20='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/state-the-boring-rpg'
alias omrA='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/the-npm-rpg'
...
alias slr='cd ~/work/src/off/sync-local-repos; git_offirmo.sh; nvm use 6'
...
alias wte='cd ~/work/src/off/web-tech-experiments; git_offirmo.sh; nvm install'
