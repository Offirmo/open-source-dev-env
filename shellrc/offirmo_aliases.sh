...
alias omr0='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use'
alias omr1='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/definitions'
alias omr2='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/data'
alias omr3='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/logic-weapons'
alias omr4='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/logic-armors'
alias omr5='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/logic-adventures'
alias omr6='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/state-prng'
alias omr7='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/state-wallet'
alias omr8='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/state-inventory'
alias omr9='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/state-character'
alias omr10='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/view-text'
alias omr11='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/state-the-boring-rpg'
alias omrA='cd ~/work/src/oa/omr; git_offirmo.sh; nvm use; cd packages/the-npm-rpg'
