...
alias mono222='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd ts-utils; ./.tabset mono222'
...
alias mono307='cd ~/work/src/off/offirmo-monorepo/3-advanced--browser; git_offirmo.sh; cd storybook--utils; ./.tabset mono307'
alias mono310='cd ~/work/src/off/offirmo-monorepo/3-advanced--browser; git_offirmo.sh; cd xoff; ./.tabset mono310'
...
alias tbrA11='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd logic--armors;      ./.tabset tbrA11'
alias tbrA12='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd logic--weapons;     ./.tabset tbrA12'
alias tbrA13='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd logic--monsters;    ./.tabset tbrA13'
alias tbrA14='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd logic--adventures;  ./.tabset tbrA14'
alias tbrA15='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd logic--shop;        ./.tabset tbrA16'
alias tbrA16='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd logic--power;       ./.tabset tbrA15'
alias tbrA21='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd rsrc--backgrounds;  ./.tabset tbrA21'
alias tbrA22='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd rsrc--audio;        ./.tabset tbrA22'
alias tbrA33='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state--character;   ./.tabset tbrA33'
alias tbrA34='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state--codes;       ./.tabset tbrA34'
alias tbrA35='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state--energy;      ./.tabset tbrA35'
alias tbrA36='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state--engagement;  ./.tabset tbrA36'
alias tbrA37='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state--inventory;   ./.tabset tbrA37'
alias tbrA38='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state--meta;        ./.tabset tbrA38'
alias tbrA39='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state--prng;        ./.tabset tbrA39'
alias tbrA40='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state--progress;    ./.tabset tbrA40'
alias tbrA41='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state--wallet;      ./.tabset tbrA41'
alias tbrA50='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd ui--rich-text;      ./.tabset tbrA50'
alias tbrA51='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd ui--browser-css     ./.tabset tbrA51'
alias tbrA52='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd ui--browser--react; ./.tabset tbrA52'
alias tbrA53='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd audio-browser;      ./.tabset tbrA53'
alias tbrA60='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd state;              ./.tabset tbrA60'
alias tbrAC1='cd ~/work/src/off/offirmo-monorepo/A-apps--core/the-boring-rpg; git_offirmo.sh; cd interfaces;         ./.tabset tbrAC1'

alias icA01='cd ~/work/src/off/offirmo-monorepo/A-apps--core/isekai-capitalist; git_offirmo.sh; cd sandbox;          ./.tabset icA01'

alias monodbm='cd ~/work/src/off/offirmo-monorepo/B-apps--support/online-adventur.es; git_offirmo.sh; cd db-migrations; ./.tabset monodbm'
alias monodb='cd ~/work/src/off/offirmo-monorepo/B-apps--support/online-adventur.es; git_offirmo.sh; cd db;             ./.tabset monodb'
alias monoi='cd ~/work/src/off/offirmo-monorepo/B-apps--support/online-adventur.es; git_offirmo.sh; cd api-interface;   ./.tabset monoi'
alias monoc='cd ~/work/src/off/offirmo-monorepo/B-apps--support/online-adventur.es; git_offirmo.sh; cd api-client;      ./.tabset monoc'
alias monof='cd ~/work/src/off/offirmo-monorepo/B-apps--support/online-adventur.es; git_offirmo.sh; cd functions;       ./.tabset monof'
alias monoh='cd ~/work/src/off/offirmo-monorepo/B-apps--support/online-adventur.es; git_offirmo.sh; cd heroku;          ./.tabset monoh'
...
alias tbrC1='cd ~/work/src/off/offirmo-monorepo/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd flux;            ./.tabset tbrC1'
alias tbrC2='cd ~/work/src/off/offirmo-monorepo/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd client--browser; ./.tabset tbrC2'
alias tbrC3='cd ~/work/src/off/offirmo-monorepo/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd client--cordova; ./.tabset tbrC3'
alias tbrC4='cd ~/work/src/off/offirmo-monorepo/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd client--node;    ./.tabset tbrC4'

alias mini01='cd ~/work/src/off/offirmo-monorepo/D-minisites; git_offirmo.sh; cd practical-logger-minisite;    ./.tabset mini01'
alias mini02='cd ~/work/src/off/offirmo-monorepo/D-minisites; git_offirmo.sh; cd universal-debug-api-minisite; ./.tabset mini02'
