...
alias onn='npm i -g iterm2-tab-set avn avn-nvm'
...
alias omr31='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/rich-text-format; ./.tabset omr31'
alias omr32='cd ~/work/src/oa/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/view-rich-text; ./.tabset omr32'
...
alias sec='cd ~/work/src/oa/oh-my-rpg && git_offirmo.sh && nvm use && cd packages/soft-execution-context; git_offirmo.sh; nvm install; ./.tabset SEC'
