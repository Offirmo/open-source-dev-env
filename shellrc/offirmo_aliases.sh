...
alias omr8='cd ~/work/src/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/state-characters'
alias omr9='cd ~/work/src/oh-my-rpg; git_offirmo.sh; nvm use; cd packages/the-boring-rpg'
