...
alias mono01='cd ~/work/src/off/offirmo-monorepo/0-stdlib; git_offirmo.sh; cd better-console-group; ./.tabset mono01'
...
alias mono10='cd ~/work/src/off/offirmo-monorepo/0-stdlib; git_offirmo.sh; cd tiny-singleton; ./.tabset mono10'
...
alias mono211='cd ~/work/src/off/offirmo-monorepo/2-advanced; git_offirmo.sh; cd rich-text-format; ./.tabset mono211'
...
alias sec0='cd ~/work/src/off/offirmo-monorepo/2-advanced; git_offirmo.sh; cd soft-execution-context; ./.tabset SEC0'
