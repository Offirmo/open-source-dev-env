...
alias mono201='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd common-error-fields; ./.tabset mono201'
...
alias mono212='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd practical-logger-browser; ./.tabset mono212'
alias mono213='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd practical-logger-node; ./.tabset mono213'
alias mono214='cd ~/work/src/off/offirmo-monorepo/2-foundation; git_offirmo.sh; cd practical-logger-minimal-noop; ./.tabset mono214'
