...
alias mono220='cd ~/work/src/off/offirmo-monorepo/stack--2022/2-foundation; git_offirmo.sh; cd print-error-to-terminal;       tabset --color "#a4d4dd" --badge mono220'
...
alias rtf1='cd ~/work/src/off/offirmo-monorepo/stack--2022/3-advanced--multi; git_offirmo.sh; cd rich-text-format-to-terminal;  tabset --color "#a4d4dd" --badge rtf1'
...
alias monoi='cd ~/work/src/off/offirmo-monorepo/stack--2022/B-apps--support/online-adventur.es; git_offirmo.sh; cd api-interface;   tabset --color "#a4d4dd" --badge monoi'
alias monoc='cd ~/work/src/off/offirmo-monorepo/stack--2022/B-apps--support/online-adventur.es; git_offirmo.sh; cd api-client;      tabset --color "#a4d4dd" --badge monoc'
alias monof='cd ~/work/src/off/offirmo-monorepo/stack--2022/B-apps--support/online-adventur.es; git_offirmo.sh; cd functions;       tabset --color "#a4d4dd" --badge monof'
alias monoh='cd ~/work/src/off/offirmo-monorepo/stack--2022/B-apps--support/online-adventur.es; git_offirmo.sh; cd heroku;          tabset --color "#a4d4dd" --badge monoh'

alias bv01='cd ~/work/src/off/offirmo-monorepo/stack--2022/A-apps/bhbv; git_offirmo.sh; cd state--isomorphic;     tabset --color "#a4d4dd" --badge bv01'
alias bv02='cd ~/work/src/off/offirmo-monorepo/stack--2022/A-apps/bhbv; git_offirmo.sh; cd flux--isomorphic;      tabset --color "#a4d4dd" --badge bv02'
alias bv03='cd ~/work/src/off/offirmo-monorepo/stack--2022/A-apps/bhbv; git_offirmo.sh; cd client--browser--core; tabset --color "#a4d4dd" --badge bv03'

alias tbrC1='cd ~/work/src/off/offirmo-monorepo/stack--2022/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd flux;            tabset --color "#a4d4dd" --badge tbrC1'
alias tbrC2='cd ~/work/src/off/offirmo-monorepo/stack--2022/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd client--browser; tabset --color "#a4d4dd" --badge tbrC2'
alias tbrC3='cd ~/work/src/off/offirmo-monorepo/stack--2022/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd client--cordova; tabset --color "#a4d4dd" --badge tbrC3'
alias tbrC4='cd ~/work/src/off/offirmo-monorepo/stack--2022/C-apps--clients/the-boring-rpg; git_offirmo.sh; cd client--node;    tabset --color "#a4d4dd" --badge tbrC4'

alias mini01='cd ~/work/src/off/offirmo-monorepo/stack--2022/D-minisites; git_offirmo.sh; cd practical-logger-minisite;    tabset --color "#a4d4dd" --badge mini01'
alias mini02='cd ~/work/src/off/offirmo-monorepo/stack--2022/D-minisites; git_offirmo.sh; cd universal-debug-api-minisite; tabset --color "#a4d4dd" --badge mini02'
