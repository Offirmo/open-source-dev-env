...
plugins=(
	## Anthropic
	## Do NOT duplicate with the above
	"claude-code-setup"
	...
	## external
	"atlassian" ## where is it defined?
	"chrome-devtools-mcp"
	"figma"
	"github"
	"playwright"
)
install_claude_plugins "claude-plugins-official" "${plugins[@]}"
...
## direct claude invocation may be better, e.g. claude plugin install figma@claude-plugins-official
